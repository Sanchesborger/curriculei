          ...
          <div className="flex items-stretch overflow-x-auto gap-3.5 pb-2 pt-0.5 no-scrollbar [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden snap-x scroll-smooth -mx-1 px-1">
            {localJobs.map((job) => (
              <div
                key={job.id}
                onClick={onOpenJobSearch}
                className="w-[280px] sm:w-[320px] flex-shrink-0 snap-start bg-[#f8fafc] dark:bg-[#0f172a] p-4 rounded-xl border border-[#c3c6d7]/50 dark:border-slate-800 hover:border-[#2563eb] dark:hover:border-blue-500 transition-all cursor-pointer flex flex-col justify-between group space-y-2.5 shadow-2xs hover:shadow-xs"
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-[10px] font-bold text-[#004ac6] dark:text-blue-300 bg-blue-100 dark:bg-blue-900/60 px-2.5 py-0.5 rounded-full">
                      {job.type}
                    </span>
                    <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-950/70 px-2.5 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800">
                  ...
                  <div className="text-xs text-[#434655] dark:text-slate-300 font-medium space-y-1 mt-1.5">
                ...
                <div className="pt-2.5 border-t border-[#c3c6d7]/30 dark:border-slate-800 flex items-center justify-between text-xs mt-2">
